        ...
        public void MethodsWithRefOrOutParams_YieldsDiagnostics()
        {
            ...
            var expected1 =
                new DiagnosticResult(commonExpected,
                                     String.Format(Resources.InnerTypesMustBePrivateMessageFormat, "Interface1"),
                                     Option<DiagnosticLocation>.Some(new DiagnosticLocation(7, 28, 38)));

            var expected2 =
                new DiagnosticResult(commonExpected,
                                     String.Format(Resources.InnerTypesMustBePrivateMessageFormat, "Enum1"),
                                     Option<DiagnosticLocation>.Some(new DiagnosticLocation(8, 21, 26)));

            var expected3 =
                new DiagnosticResult(commonExpected,
                                     String.Format(Resources.InnerTypesMustBePrivateMessageFormat, "Class2"),
