...
namespace Arnolyzer.Tests.SyntacticAnalyzers.EncapsulationAnalyzers
{
    ...
    public class AA1101ClassPropertiesShouldBePubliclyRead_OnlyAnalyzer_Tests
    {
        ...
        public void AnalyzerCorrectlySetsItsDetails()
        {
            ...
            AreEqual("AA1101ClassPropertiesShouldBePubliclyReadOnly", details.DiagnosticId);
            AreEqual(Resources.AA1101ClassPropertiesShouldBePubliclyReadOnlyTitle, details.Title.ToString());
            AreEqual(Resources.AA1101ClassPropertiesShouldBePubliclyReadOnlyDescription, details.Description.ToString());
            AreEqual(Resources.AA1101ClassPropertiesShouldBePubliclyReadOnlyMessageFormat, details.MessageFormat.ToString());
        }
