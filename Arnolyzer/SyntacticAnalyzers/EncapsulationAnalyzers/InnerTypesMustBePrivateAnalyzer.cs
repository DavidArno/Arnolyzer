...
namespace Arnolyzer.SyntacticAnalyzers.EncapsulationAnalyzers
{
    ...
    public class InnerTypesMustBePrivateAnalyzer : DiagnosticAnalyzer
    {
        ...
        private static readonly LocalizableString Title =
            LocalizableResourceString(nameof(Resources.InnerTypesMustBePrivateTitle));

        private static readonly LocalizableString MessageFormat =
            LocalizableResourceString(nameof(Resources.InnerTypesMustBePrivateMessageFormat));

        private static readonly LocalizableString Description =
            LocalizableResourceString(nameof(Resources.InnerTypesMustBePrivateDescription));
